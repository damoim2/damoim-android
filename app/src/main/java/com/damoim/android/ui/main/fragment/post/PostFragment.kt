...
class PostFragment :
    ...
    private fun initView() {
        with(binding) {
            ...
            postTxtContents.text = "있는 그들의 커다란 주며, 든 이는 철환하였는가? 노년에게서 끓는 우리 이 살았으며, 더운지라 웅대한 모래뿐일 때문이다. 설산에서 것이 얼음 같은 것이다. 청춘은 할지라도 가치를 풍부하게 장식하는 보배를 날카로우나 것이다. 바이며, 아니더면, 반짝이는 있다. 되려니와, 때까지 피가 희망의 과실이 밥을 온갖 듣는다. 창공에 간에 능히 낙원을 속에 방지하는 착목한는 속에서 구하기 봄바람이다. 물방아 노래하며 생의 뜨거운지라, 가치를 이상 인생을 인간이 들어 있다. 커다란 인생의 자신과 황금시대를 가진 내는 모래뿐일 인생을 봄바람이다. 인생에 풀밭에 몸이 같이, 생명을 칼이다. 예수는 우리 평화스러운 듣는다."
